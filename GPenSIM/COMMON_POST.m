...
if ismember(transition.name, {'tTPe_1_Add_FaceDown', ...
        'tTPe_2_Add_FaceDown', 'tTPe_3_Add_FaceDown', ...
        'tTPe_4_Add_FaceDown', 'tTPe_5_Add_FaceDown', ...
        'tTPe_6_Add_FaceDown', 'tTPe_7_Add_FaceDown'}),
    global_info.CARDS_DEALT = global_info.CARDS_DEALT + 1;
elseif ismember(transition.name, {'tTPe_1_Add_FaceUp', ...
        'tTPe_2_Add_FaceUp', 'tTPe_3_Add_FaceUp', ...
        'tTPe_4_Add_FaceUp', 'tTPe_5_Add_FaceUp', ...
...
elseif ismember(transition.name, {
        ...
        'tMC_DP_Move_Destroyer', 'tMC_FP_Move_Destroyer', ...
        'tMC_Out_Buffer_Destroyer', 'tMC_TP_Move_Destroyer', ...
        'tMC_TP_Turn_Destroyer'}),
...
elseif ismember(transition.name, {'tTPi_1_Move_Multiple',...
        'tTPi_2_Move_Multiple', 'tTPi_3_Move_Multiple', ...
        'tTPi_4_Move_Multiple', 'tTPi_5_Move_Multiple', ...
        'tTPi_6_Move_Multiple', 'tTPi_7_Move_Multiple'}),
    global_info.TP_Move_Multi_Gen_Tokens = ...
        global_info.TP_Move_Multi_Gen_Tokens - 1;
end;
