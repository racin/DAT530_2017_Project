function [png] = tableau_pile_6_pdf() 
modname = '6';
...
png.set_of_Ts = {strcat('tTPe_',modname,'_Add_FaceUp'),strcat('tTPe_',modname,'_Add_FaceDown'),strcat('tTPe_',modname,'_Move'), ...
    strcat('tTPe_',modname,'_Turn'),strcat('tTPe_',modname,'_Out'),strcat('tTPe_',modname,'_Move_Multiple')}; 
png.set_of_As = {
    ...
    strcat('tTPe_',modname,'_Move_Multiple'), strcat('pTP_',modname,'_Move'), 2, ...
    strcat('pTP_',modname,'_Move'), strcat('tTPe_',modname,'_Move_Multiple'), 1
    };
png.set_of_Is = {
