...
png.set_of_Ts = {'tMC_Out_Buffer_Destroyer', 'tMC_DP_Move_Destroyer', ...
    'tMC_TP_Turn_Destroyer', 'tMC_TP_Move_Destroyer', 'tMC_FP_Move_Destroyer'};
png.set_of_As = {
    'tDPe_Out', 'pMC_Out_Buffer', 1, ...
    'pMC_DP_Turn', 'tDPe_Turn', 1, ...
    'pMC_DP_Move', 'tDPe_Move', 1, ...
    'pMC_Out_Buffer', 'tMC_Out_Buffer_Destroyer', 1, ...
    'pMC_DP_Move', 'tMC_DP_Move_Destroyer', 1, ...
    'pMC_TP_Turn', 'tMC_TP_Turn_Destroyer', 1, ...
    'pMC_TP_Move', 'tMC_TP_Move_Destroyer', 1, ...
    'pMC_FP_Move', 'tMC_FP_Move_Destroyer', 1, ...
    };
