...
The only external-output of the {fp} is \verb!tFPe_Clubs_Out!. I
...
\begin{table}
	...
	\begin{tabular}{|l|l|l|}
		...
		& Name & Description \\
		\hline
		1  & pFP\_Clubs\_Move        &  \\ \hline
		2  & pFP\_Clubs\_Pile        &  \\ \hline
		3  & tFPe\_Clubs\_Add        &    \\ \hline
		4 & tFPe\_Clubs\_Move        &    \\ \hline
		5 & tFPe\_Clubs\_Out         &    \\ \hline
	\end{tabular}
\end{table}
\clearpage
