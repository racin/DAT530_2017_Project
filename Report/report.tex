...
Patience games are assumed to have originated in Germany or Scandinavia in the 18th century. Klondike, or Solitaire as it has been called in North America is one of the most popular in this family of games.
\newline
...
\newline
 ...
 The deck is shuffled and the cards are laid out in seven piles from left to right. There is one upturned card at the beginning of each pile. The first pile to the left contains one card, the second pile contains two cards and so on up to the seventh pile which contains seven cards. There is one upturned card on each pile - the first and left-most pile is comprised therefore only of the upturned card. 
The piles are illustrated in figure...
